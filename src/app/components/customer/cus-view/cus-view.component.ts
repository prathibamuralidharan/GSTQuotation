...
isSaveIcon:boolean=true
  ...
  constructor(private ufb: FormBuilder, private cusService: CustomerService) {
    this.updateCustomerForm = this.ufb.group({
      id:[],
      comId: [],
      cusId:[],
      cusName: ['', [Validators.required, Validators.pattern('[A-Za-z ]+')]],
      cusConPerson: ['', [Validators.required, Validators.pattern('[A-Za-z ]+')]],
      cusConPhone: ['',[Validators.required, Validators.pattern(/^[1-9][0-9]{9}$/)],],
      cusEmail: ['',[Validators.required,Validators.pattern( /^[a-zA-Z0-9._%+-]+@[a-z]+.([a-z]{2})+(?:\.(com|in|edu|net)){1}$/)]],
      cusGst: ['',[Validators.required,Validators.pattern(/^\d{2}[A-Z]{5}\d{4}[A-Z]{1}\d{1}[A-Z\d]{2}$/)]],
      cusBillAndShip: ['', [Validators.required]],
      cusBAdd1: ['', [Validators.required]],
      cusBAdd2: ['', [Validators.required]],
      cusSAdd1: [],
      cusSAdd2: [],
      cusBPcode: ['',[Validators.required, Validators.pattern(/^[1-9][0-9]{5}$/)]],
      cusSPcode: [],
